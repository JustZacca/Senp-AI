...
if ($_SERVER['REQUEST_METHOD'] == 'GET' && !empty($_GET['ID'])) {
    ...
    echo ' <div class="media"> <div class="media-body"><div class="card text-white bg-dark mb-3" style="width: 16rem;">
  ...
  if($ani->getTrailer() != "")
  {
    ...
    <iframe class="embed-responsive-item" src="'.$ani->getTrailer().'" allowfullscreen></iframe>';
  }
  else
  {
    echo'<figure class="figure">
    <img src="./assets/img/404/'.$users->getRandomFromArray($users->getImagesFromDir(404)).'" alt="...">
    <figcaption class="figure-caption">'; ?> if i can't find the trailers, I put stupid pictures.<br> Graphically I don't know how to do better, if you are a front-end do it for me</figcaption><?php
  echo '</figure>';
  }
