...
<div class="container">
    ...
    <div class="col-md-12">
        <dl class="row">
            ...
            <dd class="col-sm-9">
                <p>Using your My Anime List I create a dataset. This dataset is without the anime name and your ratings
                    but
                    keeps the status(Dropped or Completed) and genre, tags, studio and other stuff. The Senp-AI uses
                    those data
                    determinate what you like and what you don't like and then compares it with the anime other anime
                    and does a
                    prediction.</p>
            </dd>

            <dt class="col-sm-3">Does it really work?</dt>
            <dd class="col-sm-9">It depends. The AI can't exactly predict the future, it can just guess. Every guess
                depends on
                your list, the quantity of the data and if the data is accurate. </dd>

            <dt class="col-sm-3 text-truncate">Will the AI improve?</dt>
            <dd class="col-sm-9">
                This AI can obviously improve, but it will not do it by itself, the ML works through assisted teaching,
                the more
                you use it the more it improves, in the appropriate section say to the AI ​​when its prediction is
                wrong, so in
