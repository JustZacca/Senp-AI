        ...
        <div class="col-md-12">
            ...
            <div class="jumbotron jumbotron-fluid">
                <div class="container">
                    ...
                    <p class="lead">
                        Use this utility to generate your suggest list: apply some filters, otherwise the AI will
                        suggest anything,
            ...
            <div id="collapseThree" class="collapse" aria-labelledby="headingThree" data-parent="#accordionExample">
                <div class="card-body">
                    ...
                    Here you can delete items from your list. But I advise you not to do this here, rather go to <a
                        href="./list_tools.php">List Tools</a> and tell <b>Senp-AI</b> that you didn't like the
                    suggestion,
                    so next
